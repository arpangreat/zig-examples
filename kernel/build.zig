...
pub fn build(b: *Builder) void {
    ...
    const target = CrossTarget{ .cpu_arch = Target.Cpu.aarch.i386, .os_tag = Target.Os.Tag.freestanding, .abi = Target.Abi.none, .cpu_features_sub = disabled_features, .cpu_features_add = enabled_features };
